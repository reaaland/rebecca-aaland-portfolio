      ...
      <main>
        <section className="case-hero">
          <div className="shell" data-reveal>
            <p className="eyebrow">Completed Frontend Simplified virtual internship</p>
            <h1>Building a larger application from a defined set of requirements.</h1>
            <p className="case-lede">
              Summarist was a Frontend Simplified virtual internship project that
              I completed and passed. I worked from supplied requirements, APIs,
              assets, and an existing visual starting point to implement the
              application flow in Next.js. This is internship project work, not a
              product or site I own.
            </p>
          ...
          <div className="case-narrative">
            ...
            <section data-reveal>
              ...
              <p>
                ...
                what they can open, save, play, and see in Settings. The work was
