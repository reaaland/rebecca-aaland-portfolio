      ...
      <main>
        <section className="case-hero case-hero-skinstric">
          ...
          <div className="shell" data-reveal>
            ...
            <h1>Building a responsive marketplace around asynchronous data and reusable UI.</h1>
            <p className="case-lede">
              I implemented Ultraverse from a supplied starter, visual direction,
              assets, APIs, and project requirements, focusing on the frontend
              behavior that turns those inputs into a working marketplace.
            </p>
            <div className="case-meta">
              ...
              <div>
                <span>Provided</span>
                <strong>Starter · Design · APIs · Requirements</strong>
              </div>
              <div>
                <span>My focus</span>
                <strong>Data · Routing · Responsive UI</strong>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="case-body shell">
          ...
          <div className="case-narrative">
            <section data-reveal>
              ...
              <h2>Turn supplied marketplace requirements into a working React experience.</h2>
              <p>
            ...
            <section data-reveal>
              ...
              <h2>Several frontend concerns had to work together instead of as isolated exercises.</h2>
              <p>
            ...
            <section className="case-outcome" data-reveal>
              ...
              <h2>I can connect data, state, routing, and responsive UI into a complete frontend flow.</h2>
              <p>
                Ultraverse is useful portfolio proof because the work goes beyond
                a static page. It required me to manage asynchronous content,
                provide useful loading states, reuse components across views,
                preserve responsive behavior, and keep navigation predictable as
                users move between collections, authors, items, and Explore.
              </p>
              <p>
